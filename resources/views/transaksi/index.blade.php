...
@section('content')
    ...
    <strong>Berhasil diupdate!</strong>Transaksi berhasil diupdate.
    </x-alert>
    @endif
    @if (session('destroy') =='success')
    <x-alert type="success">
        <strong>Berhasil dihapus!</strong>Transaksi berhasil dihapus.
    </x-alert>
    @endif
    ...
    <div class="card card-orange card-outline">
        <div class="card-header form-inline">
            <a href="{{ route('transaksi.create') }}" class="btn btn-primary">
                <i class="fas fa-plus mr-2"></i> Buat Transaksi Baru </a>
                <form action="?" method="get" class="ml-auto">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search"
                        value="<?= request()->search ?>" placeholder="Nomor Transaksi">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                $iconStatus = $penjualan->status == 'selesai' ? 'fa-check text-succes' : 'fa-times text-danger'
                            @endphp
