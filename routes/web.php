...
Route::middleware('auth')->group(function(){
    ...
    Route::get('transaksi/{transaksi}/restore-stock', [TransaksiController::class, 'restoreStock'])
        ->name('transaksi.restore-stock');
    ...
    Route::get('/pelanggan/autocomplete', 'PelangganController@autocomplete')->name('pelanggan.autocomplete');
});
